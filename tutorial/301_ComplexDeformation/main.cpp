...
bool UpdateCurrentView()
{
  ...
  switch(viewingMode){
    case FACE_CONCYCLITY:
      hedra::concyclity(currV,D,F,scalarMeasure);
      scalarMeasure/=circSensitivity;
      break;
    case QC_ERROR:
      hedra::qc_error(origV, currV,D,F,scalarMeasure);
      scalarMeasure/=QCSensitivity;
      break;
    case MC_ERROR:
      hedra::dc_error(origV, currV, D, F, EV, EF, EFi, innerEdges, scalarMeasure);
      scalarMeasure/=MCSensitivity;
      break;
    case IA_ERROR:
      hedra::ia_error(origV, currV, D, F, EV, EF, EFi, innerEdges, scalarMeasure);
